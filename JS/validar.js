...
const iniciarsesion=()=>{
    ...
    console.log(check);
        if(check=="PC"){
            ...
            $query = `Select nombre,apellidoP,apellidoM from inicioSesionPaciente where id_inicio='${usuario1}'`;
            ...
            return;
                ...
                if(long>0){
                    ...
                    var listaUsuarios=[{nombre:nombre,apellidop:apellidop,apellidom:apellidom}];
        ...
        if(check=="MD"){
            ...
            $query = `Select nombre,apellidoP,apellidoM from inicioSesionMedico where id_inicio='${usuario1}'`;
            conexion.query($query, function (err, rows){
